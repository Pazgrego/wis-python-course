...
**Sanity hint:** when **C2 ≥ C1** (not a real dilution), the GUI shows a short note under the result; the CLI prints one line to **stderr** after the numbers.
...
Run every command from the `Day4/` directory.
